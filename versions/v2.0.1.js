...
// Determine What LIRI is getting asked to do.
  var possible = ["twitter","myTwitter","my-tweets","songs","spotify","song", "spotifyThis","spotifyThisSong","spotify-this","spotify-this-song","omdb-this","omdb","omdbThis", "movieThis","movies","rando","random","randomThis","random-this","weather", "weather","this-weather","thisWeather","weatherThis","weather-this","weather-get","get-weather", "count", "countTo","countUpTo", "count-to", "help","about","status", "start","init", "stop", "kill","update", "latest", "clone","build", "setup"]
...
${chalk.blue(" Status: Processes Up-to-Date, running commands utility: ")}
\n`); // end chalk board
console.log("Here's what's possible with your current version of LIRI: " + version + "" + "\n" + chalk.red(possible)); 
} // end print()
function update(){
  console.log(
`
...
//     })
  ...
  if (err) {
    ...
    console.log('The "----Logs---" were updated at logs.txt');
  }
});
